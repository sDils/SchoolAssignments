...
public class BlockManager
{
	 ...
	 */
	private static Semaphore s1 = new Semaphore(-4);
	...
	static class AcquireBlock extends BaseThread
	{
		...
		{
			//---------------------------------------
			//Mutex wait ensure atomicity of phase 1
			//---------------------------------------
			mutex.P();
			System.out.println("\n\n*******************************************************");
			...
			//----------------------------------------
			//Release mutex once Phase 1 is completed
			//----------------------------------------
			mutex.V();
			
			//------------------------------------------------
			//Using semaphores we ensure that Phase 2 doesn't
			//start before all Phase 1 are complete
			//------------------------------------------------			
			s1.P();
			s2.V();
			
			//---------------------------------------------
			//Continually checks whether or not if current 
			//thread is allowed to go
			//---------------------------------------------
			do
			{
				mutex.P();
	...
	static class CharStackProber extends BaseThread
	{
		public void run()
		{
			...
			mutex.P();
			System.out.println("\n\n*******************************************************");
			System.out.println("StackProber thread [TID=" + this.iTID + "] starts executing.");
			...
			System.out.println("StackProber thread [TID=" + this.iTID + "] terminates.");
			System.out.println("*******************************************************\n\n");
